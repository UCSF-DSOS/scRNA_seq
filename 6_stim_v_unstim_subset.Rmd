...
We first read in the two count matrices and set up the Seurat objects. NOTE: Unzip the subset_xxxx_exp_mat.zip archives prior to running. (If pushing to github repo, add these to .gitignore)
```{r}
library(Seurat)
library(cowplot)
...
ctrl.data.mtx <- as(as.matrix(ctrl.data), "dgCMatrix") #makes a sparse matrix of ctrl.data dataframe to make creating a Seurat object easier
