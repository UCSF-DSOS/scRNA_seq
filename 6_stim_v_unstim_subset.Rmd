...
# NOTE: Unzip the subset_xxxx_exp_mat.zip archives prior to running.
ctrl.data <- read.table(file = "./data/subset_ctrl_exp_mat.txt.gz", sep = "\t")
...
stim.data <- read.table("./data/subset_stim_exp_mat.txt.gz", sep = "\t")
