...
TODO: keep instructions here? Move instructions to 00_umap file?

If you haven't installed UMAP, you can do so via the bash shell:
`$ pip install umap-learn --user`
or via the R console / conda: 
`> reticulate::py_install(packages = 'umap-learn')`
Further instructions for this in the github.
