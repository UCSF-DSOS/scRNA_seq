...
```{r}
# TODO: discuss sequence of resolutions (.4-2, plot each, pick favorite), vary dims?
# TODO: identify and note spots where we need to edit dims to keep consistent - set a dims var
...
Please make sure you have run through the setup instructions in the github `README.md`: https://github.com/UCSF-DSI/scRNA_seq/blob/master/README.md
This troubleshooting module is available and commented out, but can be used if your systm cannot find UMAP. Please flag a TA/Instructor before using this.
