...
ctrl.sub.head = head(ctrl.data)
stim.sub.head = head(stim.data)

# remove unecessary dfs from memory
rm(t.ctrl.data, t.stim.data, t.ctrl.data.og, t.stim.data.og)

# write out subset data - practice with head
write.table(ctrl.sub.head, file = "./data/subset_ctrl_exp_mat_head.txt", quote=FALSE, sep='\t', col.names = TRUE)
write.table(stim.sub.head, file = "./data/subset_stim_exp_mat_head.txt", quote=FALSE, sep='\t', col.names = TRUE)
test = read.delim("./data/subset_ctrl_exp_mat_head.txt")
```
