...
```
Scaling is an essential step in the Seurat workflow, but only on genes that will be used as input to PCA. By default, ScaleData will perform scaling on all genes. However, it is possible to perfrom scaling on only the 2000 variable genes, the genes necessary to generate your PCA and clustering results in the next workbook.
